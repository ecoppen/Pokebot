...
class PokemonStock(Base):
    __tablename__ = "pokemon_stock"
...
class Database:
    def __init__(self, config: Database_) -> None:
        ...
        class PokemonStock(self.Base):  # type: ignore
            __tablename__ = "pokemon_stock"
    ...
    def check_then_add_or_update_pokemon(self, data):
        statistics = {"New": 0, "Updated": 0, "Deleted": 0}
        output = []
        table_object = self.get_table_object(table_name="pokemon_stock")
        check = (
